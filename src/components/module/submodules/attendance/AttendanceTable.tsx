              ...
              <TableRow key={attendance.id}>
                ...
                <TableCell>
                  <Badge 
                    variant="outline"
                    className={`
                      ${attendance.validation === 'En attente' ? 'border-amber-500 text-amber-500' : ''}
                      ${attendance.validation === 'Validé' ? 'border-green-500 text-green-500' : ''}
                      ${attendance.validation === 'Rejeté' ? 'border-red-500 text-red-500' : ''}
                    `}
                  >
